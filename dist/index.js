(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("SpaceForm", [], factory);
	else if(typeof exports === 'object')
		exports["SpaceForm"] = factory();
	else
		root["SpaceForm"] = factory();
...
var _inputLayout = __webpack_require__(8);

var _inputLayout2 = _interopRequireDefault(_inputLayout);
...
var clone = function clone(obj) {
	...
	iterate(obj, function (value, key) {
		newObj[key] = (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' ? clone(value) : value;
	});

	return newObj;
};

var _validate = function _validate(data, fields) {
	var allValid = true;

	var fieldKeys = Object.keys(fields);
	var validation = fieldKeys.reduce(function (allValidation, key) {
		var item = data[key];
		var field = fields[key];

		var addedValidation = {};
		var valid = field.validate(item);
...
exports.default = {
	...
	methods: {
		...
		submit: function submit() {
			...
			this.validate().then(function () {
				_this.valid = true;
				_this.form.resolve(_this.value);
		...
		validate: function validate() {
			...
			return new Promise(function (resolve, reject) {
				...
				_this2.$nextTick(function () {
					var validation = _validate(_this2.value, _this2.form.fields);

					if ((typeof validation === 'undefined' ? 'undefined' : _typeof(validation)) === 'object' && Object.keys(validation).length) {
						reject(validation);
	...
	components: {
		InputLayout: _inputLayout2.default
	}
};
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.layout, function(item) {
      return _c(
        "div",
        { key: item, staticClass: "input-item" },
        [
          _c(_vm.formInputs[_vm.fields[item].component], {
            tag: "component",
            attrs: {
              options: _vm.fields[item].options,
              fields: _vm.fields[item],
              errors: _vm.errors[item] || {}
            },
            model: {
              value: _vm.childrenValues[item],
              callback: function($$v) {
                _vm.$set(_vm.childrenValues, item, $$v)
              },
              expression: "childrenValues[item]"
            }
          })
        ],
        1
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "space-form easy-scroll" }, [
    _c("div", { staticClass: "top-bar" }, [
      _c("h1", [_vm._v(_vm._s(_vm.form.title))]),
      _c("div", { staticClass: "icon-close", on: { click: _vm.cancel } })
    ]),
    _c(
      "div",
      ...
      [
        _c("input-layout", {
          attrs: {
            ...
            "form-inputs": _vm.form.components,
            errors: _vm.errors,
            "starting-data": _vm.initialData
          },
          on: {
